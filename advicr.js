...
var url = 'https://quotes-inspirational-quotes-motivational-quotes.p.rapidapi.com/quote?token=ipworld.info';
var options = {
    method: 'GET',
    headers: {
...
function fetchQuote() {
    return __awaiter(this, void 0, void 0, function () {
        var response, data, quoteElement, authorElement, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    error_1 = _a.sent();
                    console.error('Error fetching or displaying quote:', error_1);
